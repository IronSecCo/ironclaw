...
// (T-227d enforces nosuid,nodev,noexec). One skill → one mount at /skills/<name>.
...
// (T-227b's Resolver) and maps the resulting validated manifest to its install
// ChangeRequest. This is the host-side flow `ironctl skill add` drives (T-227e):
