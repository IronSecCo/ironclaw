// OWNER: T-260d (credential vault — broker<->vault audit correlation)
...
// (.agents/spikes/credential-vault.md §5/§6.1).
//
...
//
// This file is the correlation unit (T-260d). Wiring Stamp into the broker Handler
