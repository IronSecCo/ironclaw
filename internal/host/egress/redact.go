// OWNER: T-260e (credential vault — broker->sandbox response redaction backstop)
...
// the sandbox (.agents/spikes/credential-vault.md §5). It is a faithful mirror of
// the T-107 model-proxy redaction (internal/host/modelproxy/hardening.go): same
...
// the redaction unit (T-260e); wiring Redact as the broker's ModifyResponse is the
