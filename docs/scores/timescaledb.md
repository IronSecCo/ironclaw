---
title: "timescaledb:2.17.2-pg17 container isolation score: 48/100 (grade D)"
description: "How isolated is timescaledb:2.17.2-pg17 by default? IronClaw scores its sandbox posture 48/100 (D): retains default capabilities. Scan any container in 10s."
---

# timescaledb:2.17.2-pg17 container isolation score: 48/100 (grade D)
...
Applying these to your `docker run timescaledb` closes the biggest gaps first (most points recovered first):
...
# grade your own timescaledb the same way this page was generated
...
Maintain **timescaledb** (or run it)? Show its default-config isolation score with a badge that links back to this scorecard:

[![Container Isolation Score: 48/100 D](https://img.shields.io/badge/container%20isolation-48%2F100%20D-e8873a)](https://ironsecco.github.io/ironclaw/scores/timescaledb/)
