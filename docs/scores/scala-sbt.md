---
title: "scala-sbt:eclipse-temurin-21.0.5_11_1.10.7_3.6.2 container isolation score: 48/100 (grade D)"
description: "How isolated is scala-sbt:eclipse-temurin-21.0.5_11_1.10.7_3.6.2 by default? IronClaw scores its sandbox posture 48/100 (D): retains default capabilities. Sc..."
---

# scala-sbt:eclipse-temurin-21.0.5_11_1.10.7_3.6.2 container isolation score: 48/100 (grade D)
...
Applying these to your `docker run scala-sbt` closes the biggest gaps first (most points recovered first):
...
```bash
docker run -d --name scala-sbt-hardened \
  --user 65532:65532 \
  --cap-drop=ALL \
  --security-opt=no-new-privileges \
  --read-only --tmpfs /tmp \
  --network=none \
  sbtscala/scala-sbt:eclipse-temurin-21.0.5_11_1.10.7_3.6.2
```
...
# grade your own scala-sbt the same way this page was generated
ironctl scan my-scala-sbt
```
...
Maintain **scala sbt** (or run it)? Show its default-config isolation score with a badge that links back to this scorecard:

[![Container Isolation Score: 48/100 D](https://img.shields.io/badge/container%20isolation-48%2F100%20D-e8873a)](https://ironsecco.github.io/ironclaw/scores/scala-sbt/)
