---
title: "keycloak:26.0.7 container isolation score: 63/100 (grade C)"
description: "How isolated is keycloak:26.0.7 by default? IronClaw scores its sandbox posture 63/100 (C): retains default capabilities. Scan any container in 10s."
---

# keycloak:26.0.7 container isolation score: 63/100 (grade C)
...
Applying these to your `docker run keycloak` closes the biggest gaps first (most points recovered first):
...
# grade your own keycloak the same way this page was generated
...
Maintain **keycloak** (or run it)? Show its default-config isolation score with a badge that links back to this scorecard:

[![Container Isolation Score: 63/100 C](https://img.shields.io/badge/container%20isolation-63%2F100%20C-d4a72c)](https://ironsecco.github.io/ironclaw/scores/keycloak/)
