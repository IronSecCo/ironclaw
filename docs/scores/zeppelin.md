---
title: "zeppelin:0.11.2 container isolation score: 63/100 (grade C)"
description: "How isolated is zeppelin:0.11.2 by default? IronClaw scores its sandbox posture 63/100 (C): retains default capabilities. Scan any container in 10s."
---
...
# grade your own zeppelin the same way this page was generated
ironctl scan my-zeppelin
```
...
Maintain **zeppelin** (or run it)? Show its default-config isolation score with a badge that links back to this scorecard:

[![Container Isolation Score: 63/100 C](https://img.shields.io/badge/container%20isolation-63%2F100%20C-d4a72c)](https://ironsecco.github.io/ironclaw/scores/zeppelin/)
