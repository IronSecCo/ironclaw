...
> Graded from a read-only `docker inspect` of `haskell:9.8` at digest `sha256:96baf4f5e29607883a48e723712046508b8a88e5d51006e2c93999cfc23cf943`. No workload is executed. [How scoring works &rarr;](../scan.md)
