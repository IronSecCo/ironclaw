...
> Graded from a read-only `docker inspect` of `grafana/alloy:latest` at digest `sha256:4f6ddc56ffdcf8a6316748fc5162972e20cb301523cac1bb4a31957df733ae9b`. No workload is executed. [How scoring works &rarr;](../scan.md)
...
Applying these to your `docker run alloy` closes the biggest gaps first (most points recovered first):
