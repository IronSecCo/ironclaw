...
> Graded from a read-only `docker inspect` of `swaggerapi/swagger-ui:latest` at digest `sha256:1ece6f19ca5709fb5fbab9bf43adee2916144fb21e82b7bafba568124e8c8930`. No workload is executed. [How scoring works &rarr;](../scan.md)
...
Applying these to your `docker run swagger-ui` closes the biggest gaps first (most points recovered first):
