---
title: "victoria-metrics:v1.107.0 container isolation score: 48/100 (grade D)"
description: "How isolated is victoria-metrics:v1.107.0 by default? IronClaw scores its sandbox posture 48/100 (D): retains default capabilities. Scan any container in 10s."
---

# victoria-metrics:v1.107.0 container isolation score: 48/100 (grade D)
...
Applying these to your `docker run victoria-metrics` closes the biggest gaps first (most points recovered first):
...
# grade your own victoria-metrics the same way this page was generated
