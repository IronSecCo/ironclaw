---
title: "home-assistant:2024.12 container isolation score: 48/100 (grade D)"
description: "How isolated is home-assistant:2024.12 by default? IronClaw scores its sandbox posture 48/100 (D): retains default capabilities. Scan any container in 10s."
---

# home-assistant:2024.12 container isolation score: 48/100 (grade D)
...
Applying these to your `docker run home-assistant` closes the biggest gaps first (most points recovered first):
...
```bash
docker run -d --name home-assistant-hardened \
  --user 65532:65532 \
  --cap-drop=ALL \
  --security-opt=no-new-privileges \
  --read-only --tmpfs /tmp \
  --network=none \
  ghcr.io/home-assistant/home-assistant:2024.12
```
...
# grade your own home-assistant the same way this page was generated
ironctl scan my-home-assistant
```
...
Maintain **home assistant** (or run it)? Show its default-config isolation score with a badge that links back to this scorecard:

[![Container Isolation Score: 48/100 D](https://img.shields.io/badge/container%20isolation-48%2F100%20D-e8873a)](https://ironsecco.github.io/ironclaw/scores/home-assistant/)
