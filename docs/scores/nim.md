---
title: "nim:2.2.0 container isolation score: 48/100 (grade D)"
description: "How isolated is nim:2.2.0 by default? IronClaw scores its sandbox posture 48/100 (D): retains default capabilities, runs as root. Scan any container in 10s."
---

# nim:2.2.0 container isolation score: 48/100 (grade D)
...
> Graded from a read-only `docker inspect` of `nimlang/nim:2.2.0` at digest `sha256:614cfede24453ceaa28100f7daf4be65d80bfba19df2861486266b2273a564e3`. No workload is executed. [How scoring works &rarr;](../scan.md)
...
Applying these to your `docker run nim` closes the biggest gaps first (most points recovered first):
...
```bash
docker run -d --name nim-hardened \
  --user 65532:65532 \
  --cap-drop=ALL \
...
# grade your own nim the same way this page was generated
ironctl scan my-nim
```
...
Maintain **nim** (or run it)? Show its default-config isolation score with a badge that links back to this scorecard:

[![Container Isolation Score: 48/100 D](https://img.shields.io/badge/container%20isolation-48%2F100%20D-e8873a)](https://ironsecco.github.io/ironclaw/scores/nim/)
