...
!!! warning "A green verify is necessary, not sufficient — check *which* build it attests"
...
running the [red-team escape harness](https://github.com/IronSecCo/ironclaw/tree/main/examples/red-team-escape)
