...
(the repository's **Security → Report a vulnerability**) or email `security@nivardsec.com`. Maintainers
acknowledge within 3 business days and aim for coordinated disclosure within 90 days. See the full
[Security Policy](https://github.com/nivardsec/ironclaw/security/policy) and the complete
[threat model](https://github.com/nivardsec/ironclaw/blob/main/docs/threat-model.md) in the repository.
